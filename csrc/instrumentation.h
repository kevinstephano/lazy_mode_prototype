...
#define LAZY_MACRO_CONCAT2(a, b) a##b
#define LAZY_MACRO_CONCAT(a, b) LAZY_MACRO_CONCAT2(a, b)
#define LAZY_ANONYMOUS(prefix) LAZY_MACRO_CONCAT(prefix, __COUNTER__)
...
//!
#define LAZY_PERF_SCOPE(name) \
  lazy_mode::inst::TraceScope LAZY_ANONYMOUS(_perf_scope_)(name)
